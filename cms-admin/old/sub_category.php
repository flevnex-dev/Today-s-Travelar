<?php 
		...
		if(isset($_POST['create'])){
			...
			{  $insert=array('category'=>$category,'name'=>$name,'date'=>date('Y-m-d'),'status'=>1);
		...
		{
			extract($_POST);if(!empty($category) && !empty($name))
			{$updatearray=array("id"=>$id);$upd2=array('category'=>$category,'name'=>$name,'date'=>date('Y-m-d'),'status'=>1);
