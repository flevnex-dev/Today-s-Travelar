    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="slider_26"></div>
            </div>
        </div>
        <!-- // Slider END -->
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},slider_text: {type: "string"},slider_image: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#slider_26").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "slider_text", title: "Slider Text"},{field: "slider_image", title: "Slider image"},
